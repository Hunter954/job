...
def _ensure_schema():
    ...
    # Company profile business fields (evita 500 em bancos antigos sem migrations)
    _add_column("company_profile", "cep", "VARCHAR(20)")
    _add_column("company_profile", "address", "VARCHAR(255)")
    _add_column("company_profile", "house_number", "VARCHAR(30)")
    _add_column("company_profile", "neighborhood", "VARCHAR(120)")
    _add_column("company_profile", "city", "VARCHAR(120)")
    _add_column("company_profile", "state", "VARCHAR(30)")
    _add_column("company_profile", "phone", "VARCHAR(40)")
    _add_column("company_profile", "website", "VARCHAR(255)")
    ...
    _add_column("company_profile", "description", "TEXT")
    _add_column("company_profile", "logo_filename", "VARCHAR(255)")
    _add_column("company_profile", "is_completed", "BOOLEAN", "false")
